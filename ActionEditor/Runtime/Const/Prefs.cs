...
namespace PKC.ActionEditor
{
    ...
    {
        public static readonly string CONFIG_PATH =   $"{Application.dataPath}/../ProjectSettings/WhootActionSequencer.txt";
        ...
        public static readonly float[] snapIntervals = new float[] { 0.1f, 0.25f, 0.5f, 0.75f };
        public static readonly float[] frameRates = new float[] { 24, 25, 30, 60, 120 };
        ...
        public static float trackListLeftMargin
        {
            ...
            set
            {
                if (Mathf.Abs(data.TrackListLeftMargin - value) > 0.001f)
                {
